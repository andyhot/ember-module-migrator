...
var FileInfo = CoreObject.extend({
  ...
  updateImports: function(projectRoot, fileInfos) {
    if (this.ext !== '.js') { return; } // only process JavaScript files

    try {
      var appName = 'my-app'; // TODO figure out how to parse this
      ...
      console.log('error parsing file ' + this.name + ' failed to apply codeshift. Possible invalid JS file. Returning original file unchanged. error: ' + e.message);
    }
  },
